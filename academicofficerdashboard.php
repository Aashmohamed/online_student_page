                    ...
                    <div class="row">
                                ...
                                <div class="col-12 mt-3 fs-5">
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center mt-3 mb-3">
                                            <a href="academicofficerProfile.php" class="btn button3 text-white py-2 rounded border border-1 fs-6">
                        ...
                        <div class="col-12 col-lg-9 mt-3 mb-3 bg-white">
                            <div class="row">
                                ...
                                <div class="col-4 d-grid bg-light text-center">
                                    <a href="register_students.php" class="btn button2 text-white py-2 rounded border border-1 fs-6">
                                        <i class="bi bi-person-circle fs-2 pe-2"></i>Register Students</a>
                                </div>

                                <div class="col-4 d-grid bg-light text-center">
                                    <a href="viewAssignment.php" class="btn button2 py-2 text-white rounded border border-1 fs-6">
                                        <i class="bi bi-cart-fill fs-2 pe-2"></i>View Assignment Mark </a>
                                </div>

                                <div class="col-4 d-grid bg-light text-center">
                                    <a href="marks.php" class="btn button2 py-2 text-white rounded border border-1 fs-6">
                                        <i class="bi bi-cart-fill fs-2 pe-2"></i> Assignment Mark Releace </a>
                                </div>

                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        $status = Database::search("SELECT * FROM studentmanagement.exam_marks a INNER JOIN `assignment_submit_status` b ON a.submit_status_id = b.id WHERE a.student_id = '" . $userID . "' ");
